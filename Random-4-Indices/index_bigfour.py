...
class IndexGraph():
    def __init__(self):
        ...
        self.masterlist = {self.indices[i]:self.masterlistallindices[self.indices[i]] for i 
                            in range(len(self.masterlistallindices)) if self.indices[i] in ("MediaTropes","GenreTropes","NarrativeTropes","TopicalTropes")}
        ...
        self.supercat = "indices_bigfour_forcomparison"
